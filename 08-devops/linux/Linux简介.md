...
Linux 是一套免费使用和自由传播的类 Unix 操作系统，支持多用户、多任务、多线程与多 CPU 场景，在服务器领域尤其常见。

面试中可以先建立一个整体认知：Linux 不只是命令集合，它本质上是一套围绕文件系统、权限模型、进程管理与 Shell 工具链展开的工作环境。
...
<div align="center"> <img src="assets/5942debd-fc00-477a-b390-7c5692cc8070.jpg" width="400"/> </div><br>
...
- `find`：按路径和文件名检索目标文件。
- `grep`：按模式匹配文件内容，常与管道组合使用。
- `awk`：按列处理文本，适合统计和格式化输出。
- `sed`：适合做批量替换、删除空行和流式编辑。
- 管道符 `|` 可以把前一个命令的标准输出交给下一个命令继续处理。
...
<div align="center"> <img src="assets/924914c0-660c-4e4a-bbc0-1df1146e7516.jpg" width="400"/> </div><br>
...
<div align="center"> <img src="assets/f9f2a16b-4843-44d1-9759-c745772e9bcf.jpg" width=""/> </div><br>
...
<div align="center"> <img src="assets/f0574025-c514-49f5-a591-6d6a71f271f7.jpg" width=""/> </div><br>

### 4. SAS

SAS（Serial Attached SCSI）是新一代的 SCSI 技术，和 SATA 硬盘相同，都是采取序列式技术以获得更高的传输速度，可达到 6Gb/s。此外也透过缩小连接线改善系统内部空间等。

<div align="center"> <img src="assets/6729baa0-57d7-4817-b3aa-518cbccf824c.jpg" width=""/> </div><br>
...
<div align="center"> <img src="assets/GUID_Partition_Table_Scheme.svg.png" width="400"/> </div><br>
...
<div align="center"> <img src="assets/50831a6f-2777-46ea-a571-29f23c85cc21.jpg"/> </div><br>
...
<div align="center"> <img src="assets/f900f266-a323-42b2-bc43-218fdb8811a8.jpg" width="600"/> </div><br>
...
<div align="center"> <img src="assets/BSD_disk.png" width="800"/> </div><br>

## 文件读取

对于 Ext2 文件系统，当要读取一个文件的内容时，先在 inode 中去查找文件内容所在的所有 block，然后把所有 block 的内容读出来。

<div align="center"> <img src="assets/83185315-793a-453a-a927-5e8d92b5c0ef.jpg"/> </div><br>

而对于 FAT 文件系统，它没有 inode，每个 block 中存储着下一个 block 的编号。

<div align="center"> <img src="assets/075e1977-7846-4928-96c8-bb5b0268693c.jpg"/> </div><br>
...
<div align="center"> <img src="assets/inode_with_signatures.jpg" width="600"/> </div><br>
...
<div align="center"> <img src="assets/linux-filesystem.png" width=""/> </div><br>
...
<div align="center"> <img src="assets/b8081c84-62c4-4019-b3ee-4bd0e443d647.jpg" width="400px"> </div><br>
...
<div align="center"> <img src="assets/658fc5e7-79c0-4247-9445-d69bf194c539.png" width=""/> </div><br>
...
<br>
<div align="center"> <img src="assets/76a49594323247f21c9b3a69945445ee.png" width=""/> </div><br>
...
<div align="center"> <img src="assets/flow.png" width=""/> </div><br>
